...
import { ONFT721URIStorageCore } from "./ONFT721URIStorageCore.sol";

/**
 * @title ONFT721URIStorage Contract
 * @dev ONFT721URIStorage is an ERC-721 token that extends the functionality of the ONFT721URIStorageCore contract.
 */
abstract contract ONFT721URIStorage is ONFT721URIStorageCore, ERC721URIStorage {
    ...
    constructor(
        ...
        address _lzEndpoint,
        address _delegate
    ) ERC721(_name, _symbol) ONFT721URIStorageCore(_lzEndpoint, _delegate) {}
    ...
    function _credit(address _to, uint256 _tokenId, string memory _tokenURI, uint32 /*_srcEid*/) internal virtual override {
        _mint(_to, _tokenId);
